 ...
 *  @brief SimplexNoise is a class used to programmatically generate noise, specifically z values given x,y values
 *
 * 	Based loosely on the C++ implementation of Simplex Noise by Sebastien Rombauts (sebastien.rombauts@gmail.com)
 *
 *  @author Sam
 *  @bug No known bugs.
 */
